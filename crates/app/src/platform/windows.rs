...
//
// That argument expired the moment these builds started running on a real
// Windows machine, and the cost of the deferral turned out to be larger
...
/// hardware test pass should surface it.
#[derive(Default)]
