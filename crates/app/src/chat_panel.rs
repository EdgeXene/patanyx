...
//!     which identity) live in the vault: they tie a person to a registered
//!     address and to whoever runs the relay operator's server, so they
//!     belong in the only encrypted store the app opens, and they lock away
//!     with the identities they reference.
...
/// discoverable from the failure otherwise. Someone typing a perfectly
...
mod tests {
    ...
    fn relay_settings_validation() {
        ...
        // which is what someone got for typing a perfectly well-formed
