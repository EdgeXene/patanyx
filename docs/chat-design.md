...
Agreed decisions, recorded. Not yet built. Sequenced AFTER the Windows port lands.
...
PER-CONTACT ADDRESSES for v1 (decided 2026-07-24): the user
...
- **Phase 2: direct peer-to-peer over the internet.** Direct peer-to-peer is a
  requirement, not an option. The point of phase 2 is to take the relay OUT of the data
...
publisher's own circle, because abuse complaints and legal process both attach to the
...
- **Private build** (`cargo build --release --features chat`): the publisher
...
TEXT ONLY. File and image transfer was removed entirely (2026-07-24,
...
**GIFs: NO.** Considered and rejected (2026-07-24) once the emoji/GIF
distinction was flagged. Do not add them back without an explicit
decision.
...
## Honest metadata caveat, stated rather than buried
...
Lattice's rules largely do not apply here: a desktop
